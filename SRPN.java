//this instance class is going to do all the lifting connecting the user input, the stack, the operators, the calculator together
...
public class SRPN {
    ...
    this means we can use mulitple unique seperate stack objects but they have the same class structure
    we're going to create type seperates stacks, one for the operands, one for the operators
    ...
    */
    ...
    //this is the main brain method that is going to connect all our other methods and classes
    ...
    //method to calculate everything, passing into the the operators and operands
